...
describe ContactRepository do
  ...
  describe '#create' do
    it 'inserts new contact into the database' do
      contact_to_save = Contact.new('Paško Patak', 'Patkogratska 22', 'Patkograd', 'California', 'USA', '90210')
  ...
  describe '#update' do
    it 'updates contact record in the database by id' do
      ...
      update_contact = Contact.new('Paško Patak Novi', 'Patkogratska 223334444', 'Patkograd', 'California', 'USA', '90210',
                                   id)
